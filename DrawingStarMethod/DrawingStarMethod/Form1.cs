...
namespace DrawingStarMethod
{
    public partial class Form1 : Form
    {
        ...
        public void DrawStar(Pen starPen, float x, float y, float pixels)
        {
            ...
            PointF[] star = 
                {
                 new PointF  (80 * scale + x, 77 * scale + y),
                 new PointF  (103 * scale + x, 4 * scale + y),   
                 new PointF  (126 * scale + x,78 * scale + y),
                 new PointF  (207 * scale + x,78 * scale + y),
                 new PointF  (143 * scale + x,125 * scale + y),
                 new PointF  (167 * scale + x,197 * scale + y),
                 new PointF  (103 * scale + x,152 * scale + y),
                 new PointF  (40 * scale + x, 196 * scale + y),
                 new PointF  (63 * scale + x, 123 * scale + y),
                 new PointF  (0 * scale + x, 77 * scale + y),
                 new PointF  (80 * scale + x, 77 * scale + y) 
                };
